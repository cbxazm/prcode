...
from comp import *
from gmnclf import *
from beforegmnc import *

c = classify()
gmnc = gmnclassify()
beforegmnc = beforegmnclassify()
cite = {}
...
def get_topK(repo, num1,num2, topK=30, print_progress=False, use_way='new'):
    ...
    for pull in pulls:
        ...
        if use_way == 'new':
            ...
            feature_vector = get_pr_sim_vector_new(pullA, pull, repo,num1,num2)
            results[pull["number"]] = gmnc.predict_proba([feature_vector])[0][1]
        elif use_way == 'beforegmnnew':
            feature_vector = get_pr_sim_vector_before_new(pullA, pull, repo, num1, num2)
            results[pull["number"]] = beforegmnc.predict_proba([feature_vector])[0][1]
