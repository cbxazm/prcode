...
# input_pairs = 'data/clf/input.txt'
# input_pairs = 'data/beforegmnclf/input.txt'
# input_pairs = 'data/pyclf/input.txt'
input_pairs = 'data/gmnclf/input.txt'
...
with open(input_pairs) as f:
    for t in f.readlines():
        ...
        if (r, n1, n2) in last_run:
            ...
            li = [int(x[0]) for x in detect.get_topK(r, n2,n1, 30, True, way)]
